    ...
    <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm">
      ...
      <div className="bg-primary px-6 py-5">
        <div className="flex items-center gap-2 mb-1">
          <Scissors size={16} className="text-primary-foreground/80" />
          <span className="text-xs font-semibold text-primary-foreground/80 uppercase tracking-wide">Instant Price Calculator</span>
        </div>
